...
INSERT INTO users (active, avatar, description, email, name, password, surname, cart_id)
            VALUES ( 1, 'nie', 'nie', 'admin@test.pl', 'Jakub', '$2y$12$Tv1EyHZEnonXbsizk3nQ5e5UJVeXjCUlotyRu6TQFDwpHWh4AOeQe', 'Testowy', 1);
